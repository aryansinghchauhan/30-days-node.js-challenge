let products = [
  ...
  { id: 6, name: 'Notebook',          category: 'stationery',  price: 149,  inStock: true,  createdAt: new Date('2026-01-06').toISOString() },
  { id: 7, name: 'USB Hub',           category: 'electronics', price: 999,  inStock: false, createdAt: new Date('2026-01-07').toISOString() },
  { id: 8, name: 'Yoga Mat',          category: 'fitness',     price: 1599, inStock: true,  createdAt: new Date('2026-01-08').toISOString() },
];
let nextId = 9;
